...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC                                                                                 // set by target:NUCLEO_H723ZG
#define HSE_VALUE                                                             8000000                                                                                          // set by target:NUCLEO_H723ZG
...
#define MBED_CONF_TARGET_I2C_TIMING_VALUE_ALGO                                1                                                                                                // set by target:MCU_STM32H723xG
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                                        1                                                                                                // set by target:NUCLEO_H723ZG
#define MBED_CONF_TARGET_LSE_DRIVE_LOAD_LEVEL                                 RCC_LSEDRIVE_LOW                                                                                 // set by target:MCU_STM32H7
#define MBED_CONF_TARGET_MPU_ROM_END                                          0x0fffffff                                                                                       // set by target:Target
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       ETHERNET                                                                                         // set by target:NUCLEO_H723ZG
#define MBED_CONF_TARGET_RTC_CLOCK_SOURCE                                     USE_RTC_CLK_LSE_OR_LSI                                                                           // set by target:MCU_STM32
#define MBED_CONF_TARGET_SYSTEM_POWER_SUPPLY                                  PWR_LDO_SUPPLY                                                                                   // set by target:MCU_STM32H723xG
#define MBED_CONF_TARGET_TICKLESS_FROM_US_TICKER                              0                                                                                                // set by target:Target
#define MBED_CONF_TARGET_USB_SPEED                                            USE_USB_HS_IN_FS                                                                                 // set by target:NUCLEO_H723ZG
...
#define STM32_D11_SPI_ETHERNET_PIN                                            PB_5                                                                                             // set by target:NUCLEO_H723ZG
// Macros
